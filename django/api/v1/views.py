...
class EntryViewSet(viewsets.ModelViewSet):
    ...
    filter_fields = {"feed_id": ["exact"], "published_time": ["gt"]}
...
class FeedViewSet(viewsets.ModelViewSet):
    ...
    filter_fields = {"title": ["icontains"], "group_id": ["exact"]}
...
class LogViewSet(viewsets.ModelViewSet):
    ...
    filter_fields = {"datetime": ["gt"], "level": ["exact"]}
...
class PageViewSet(viewsets.ModelViewSet):
    ...
    filter_fields = {"parent_id": ["exact"], "slug": ["exact"], "title": ["icontains"]}
    lookup_field = "slug"
...
def content_types(request):
    content_types = [
        {"value": value, "label": label} for value, label in CONTENT_TYPE_CHOICES
    ]
